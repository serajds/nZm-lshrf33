...
info:
  ...
  title: Api
  version: 0.1.0
  description: API specification for Engineering Supervision System
servers:
  - url: /api
...
tags:
  ...
  - name: owner-portal
    description: Owner read-only portal
  - name: project-members
    description: Project member management
  - name: dashboard
    description: Dashboard analytics
  - name: attendance
    description: Staff attendance check-in/check-out
...
paths:
  ...
  /auth/login:
    post:
      ...
      responses:
        ...
        "403":
          description: Account not yet activated by admin
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/ErrorResponse"
  ...
  /auth/register:
    post:
      ...
      responses:
        "201":
          description: Account created (inactive — awaiting admin activation)
          content:
            application/json:
              schema:
      ...
      responses:
        "201":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/ImportActivitiesResponse"
        "400":
    ...
    patch:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateActivityBody"
      responses:
        "200":
    ...
    patch:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateReportBody"
      responses:
        "200":
  ...
  /projects/{projectId}/reports/{id}/status:
    patch:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateReportStatusBody"
      responses:
        "200":
          description: Updated report
          content:
          ...
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: "#/components/schemas/ReportAuditLogEntry"

  /projects/{projectId}/reports/export-pdf:
    get:
      operationId: exportReportsPdf
      tags: [reports]
  ...
  /projects/{projectId}/eligible-users:
    get:
    ...
    patch:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateProjectMemberBody"
      responses:
        "200":
  ...
  /projects/{projectId}/members/{id}/groups:
    put:
      operationId: updateMemberGroups
      tags: [project-members]
  ...
  /projects/{projectId}/members/{id}/permissions:
    get:
      operationId: getMemberTabPermissions
      tags: [project-members]
      ...
      responses:
        "200":
          description: Effective tab permissions
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/MemberTabPermissions"
    put:
      operationId: updateMemberTabPermissions
      tags: [project-members]
          ...
          application/json:
            schema:
              ...
              properties:
                tabPermissions:
                  oneOf:
                    - $ref: "#/components/schemas/TabPermissionsMap"
                    - type: "null"
              required:
                - tabPermissions
      responses:
  ...
  /users/incomplete-count:
    get:
      operationId: getIncompleteUsersCount
      tags: [users]
  ...
  /owner/access/{token}:
    get:
      operationId: getOwnerProjectByToken
      tags: [owner-portal]
    ...
    post:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/OwnerVerifyBody"
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/OwnerProjectView"
        "401":
  ...
  /projects/{projectId}/deviation:
    get:
      operationId: getProjectDeviation
      tags: [dashboard]
      ...
      parameters:
        ...
        - name: curve
          ...
          schema:
            ...
            enum: [linear, scurve]
            default: linear
          description: Planned-progress curve model used for the calculation.
      responses:
        "200":
  ...
  /projects/{projectId}/deviation/timeline:
    get:
      operationId: getProjectDeviationTimeline
      tags: [dashboard]
      ...
      parameters:
        ...
        - name: curve
          ...
          schema:
            ...
            enum: [linear, scurve]
            default: linear
          description: Planned-progress curve model used for the historical points.
      responses:
        "200":
          description: Deviation timeline
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/DeviationTimeline"

  /projects/{projectId}/generate-owner-link:
    post:
      operationId: generateOwnerLink
      tags: [projects]
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/GenerateOwnerLinkBody"
      responses:
        "200":
          description: Generated owner link
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/OwnerLinkResponse"

  # Attendance
  /attendance/my-status:
    get:
      operationId: getMyAttendanceStatus
      tags: [attendance]
      summary: Get my current check-in status across my projects
      responses:
        "200":
          description: Status per project
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: "#/components/schemas/MyAttendanceProjectStatus"
          ...
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: "#/components/schemas/MyAttendanceHistoryItem"
    ...
    patch:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateAttendanceRecordBody"
      responses:
        "200":
    ...
    delete:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/DeleteAttendanceRecordBody"
      responses:
        "204":
          description: Deleted
    ...
    post:
      ...
      requestBody:
        ...
        content:
          multipart/form-data:
            schema:
              $ref: "#/components/schemas/AttendanceCheckBody"
      responses:
        "201":
  ...
  /attendance/projects/{projectId}/active:
    get:
      ...
      responses:
        "200":
          description: Currently checked-in members
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/ActiveAttendanceResponse"
          ...
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: "#/components/schemas/AttendanceRecordWithUser"

  /attendance/projects/{projectId}/users/{userId}/report:
    get:
      operationId: getEmployeeAttendanceReport
      tags: [attendance]
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/EmployeeAttendanceReport"
  ...
  schemas:
    ...
    User:
      ...
      properties:
        ...
        role:
          type: string
          enum: [admin, project_manager, engineer, owner, contractor]
        companies:
          type: array
          items:
    ...
    TabPermissionsMap:
      ...
      properties:
        overview:
          $ref: "#/components/schemas/TabAccess"
        activities:
          $ref: "#/components/schemas/TabAccess"
        extensions:
          $ref: "#/components/schemas/TabAccess"
    ...
    Project:
      ...
      properties:
        ...
        siteRadiusMeters:
          type: ["integer", "null"]
        attendanceAutoCloseHours:
          type: integer
        attendanceLongDayHours:
          type: integer
        createdAt:
          type: string
          format: date-time
    ...
    UpdateProjectBody:
      ...
      properties:
        ...
        status:
          type: ["string", "null"]
          enum: [active, completed, delayed, suspended, null]
        overallProgress:
          type: ["number", "null"]
        siteLatitude:
          type: ["number", "null"]
    ...
    Activity:
      ...
      properties:
        ...
        weight:
          type: number
          description: Relative weight (cost share / volume share). Default 1.
          default: 1
        status:
          type: string
    ...
    UpdateActivityBody:
      ...
      properties:
        ...
        status:
          type: ["string", "null"]
          enum: [not_started, in_progress, completed, delayed, null]
        sortOrder:
          type: ["integer", "null"]
        groupId:
          type: ["integer", "null"]
        ...
        activitiesSnapshot:
          ...
          items:
            ...
            properties:
              ...
              weight:
                type: number
                description: Activity weight (cost/volume share) used for the report's weighted progress.
              status:
                type: string
              sortOrder:
                type: integer
    ...
    ProjectFile:
      ...
      properties:
        ...
        category:
          type: string
          enum: [image, pdf, test_result, document, other]
        fileUrl:
          type: string
        fileSize:
          type: integer
        ...
        allProjects:
          ...
          items:
            ...
            properties:
              ...
              overrunDays:
                type: integer
                description: Days passed after expectedEndDate while progress < 100%
        recentReports:
          type: array
          items:
            type: object
    ...
    DeviationAnalysis:
      ...
      properties:
        ...
        plannedProgress:
          type: number
          description: Weighted planned progress for the project at today's date.
        actualProgress:
          type: number
          description: Weighted actual progress (overall project progress).
        status:
          type: string
          enum: [on_track, slightly_delayed, significantly_delayed, ahead]
        criticalPathStatus:
          type: string
          enum: [healthy, at_risk, critical]
          description: Health of the critical path based on the count of activities deviating > 10%.
        suspensionDays:
          type: integer
        grossDelayDays:
          type: integer
        ...
        spi:
          type: ["number", "null"]
          description: Schedule Performance Index = actual / planned (>1 ahead, <1 behind).
        forecastCompletionDate:
          type: ["string", "null"]
          format: date
          description: Forecast completion date if the current pace continues.
        expectedProgressAtEnd:
          type: number
          description: Expected progress percentage at the contractual end date if the current pace continues.
        contractEndDate:
          type: ["string", "null"]
          format: date
        forecastDelayDays:
          type: integer
          description: Days between forecastCompletionDate and contractEndDate (positive = late).
        suspensionsBreakdown:
          type: array
          description: Breakdown of suspension days by cause type.
          items:
            type: object
            properties:
              type:
                type: string
                enum: [official_holiday, force_majeure, contractor_delay]
              days:
                type: integer
              count:
                type: integer
        ...
        recommendations:
          type: array
          description: Auto-generated recommendations based on the project state.
          items:
            type: object
            properties:
              severity:
        ...
        activitiesAnalysis:
          type: array
          items:
            $ref: "#/components/schemas/ActivityDeviation"
        noSchedule:
          type: boolean
      required:
        - projectId
    ...
    ActivityDeviation:
      ...
      properties:
        ...
        weight:
          type: number
          description: Activity weight used in the project-level weighted average.
        weightedImpact:
          type: number
          description: Contribution of this activity's deviation to overall project deviation (= deviation × weight / totalWeight).
        delayDays:
          type: ["integer", "null"]
          description: Deprecated alias for overrunDays (kept for backward compatibility)
        overrunDays:
          type: ["integer", "null"]
          description: Days past activity plannedEndDate while not completed
      required:
        - activityId
        - activityName
        - plannedProgress
    ...
    DeviationTimeline:
      ...
      properties:
        ...
        suspensionsBreakdown:
          type: array
          description: Breakdown of suspension days by cause type for this project.
          items:
            type: object
            properties:
              type:
    ...
    ActiveAttendanceResponse:
      ...
      properties:
        ...
        members:
          type: array
          items:
            $ref: "#/components/schemas/ActiveAttendanceMember"
      required:
        - activeCount
        - members
    ...
    EmployeeAttendanceDay:
      ...
      properties:
        ...
        sessions:
          type: array
          items:
            $ref: "#/components/schemas/AttendanceReportSession"
        totalMinutes:
          type: integer
        flags:
          type: object
    ...
    EmployeeAttendanceReport:
      ...
      properties:
        ...
        days:
          type: array
          items:
            $ref: "#/components/schemas/EmployeeAttendanceDay"
        summary:
          type: object
          properties:
            totalMinutes:
